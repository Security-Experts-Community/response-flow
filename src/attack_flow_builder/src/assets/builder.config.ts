...
import publisher from "./CacaoPublisher";
...
const config: AppConfiguration = {
    is_web_hosted: false,
    file_type_name: "Response Flow",
    file_type_extension: "rfp",
    schema: {
        page_template: "flow",
        templates: [
            {
            ...
            {
                id: "or",
                namespace: "operators.OR_operator",
            ...
            {
                id: "and",
                namespace: "operators.AND_operator",
                type: TemplateType.TextBlock,
                role: SemanticRole.Node,
                properties: {
                    operator: {
    ...
    menus: {
        help_menu: {
            help_links: [
                {
                    text: "ERM&CK (Enterprise Response Model & Common Knowledge)",
                    url: "https://security-experts-community.github.io/ERMACK/"
                },
                {
                    text: "ERM&CK Repository",
                    url: "https://github.com/Security-Experts-Community/ERMACK"
                },
                {
                    text: "Response Flow Repository",
                    url: "https://github.com/Security-Experts-Community/response-flow"
                }
            ]
        }
    },
