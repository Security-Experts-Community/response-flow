...
// Dependencies
import {clamp, Colors, DarkTheme, PropertyType, SemanticRole, TemplateType} from "./assets/scripts/BlockDiagram";
...
import {LoadErmack} from "@/store/Commands/AppCommands/LoadErmack";
...
export default defineComponent({
    ...
    async created() {
        ...
        // load Ermack actions
        const ermackContent = await (await fetch('http://localhost:3000/list')).json();
